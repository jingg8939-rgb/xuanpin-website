...
export const products: Product[] = [
  ...
  {
    slug: "transparent-filler-masterbatch",
    category: "performance",
    image: "/products/transparent-filler.jpg",
    specifications: [
      { label: "Carrier", value: "PE / PP" },
      { label: "Na₂SO₄ Content", value: "60-80%" },
      { label: "Melt Flow Index", value: "3-15 g/10min" },
      { label: "Density", value: "1.60-2.00 g/cm³" },
      { label: "Processing Temperature", value: "160-240°C" },
      { label: "Form", value: "Cylindrical granules, 3-4mm" },
      { label: "Particle Size", value: "D50: 2-5 μm" },
      { label: "Transparency", value: "High" },
    ],
    en: {
      name: "Transparent Filler Masterbatch",
      categoryLabel: "Functional & Performance Masterbatch",
      shortDescription: "Sodium sulfate (Na₂SO₄) based transparent filler masterbatch for cost reduction while maintaining film clarity and transparency.",
      description: "Our Transparent Filler Masterbatch uses high-purity sodium sulfate (Na₂SO₄) as the filler material, specially processed to maintain excellent transparency in plastic films. Unlike calcium carbonate which causes opacity, this masterbatch allows significant cost reduction while preserving the clarity and visual appearance of the final product. Ideal for applications where transparency is essential.",
      applications: ["Transparent packaging films", "Shopping bags", "Agricultural films", "Lamination films"],
      features: [
        "High Na₂SO₄ loading (up to 80%)",
        "Maintains film transparency and clarity",
        "Significant cost reduction vs. pure resin",
        "Excellent dispersion and processability",
        "Compatible with PE and PP systems",
    ...
    zh: {
      name: "透明填充母粒",
      categoryLabel: "功能与性能母粒",
      shortDescription: "硫酸钠（Na₂SO₄）透明填充母粒，在保持薄膜透明度的同时降低成本。",
      description: "我们的透明填充母粒采用高纯度硫酸钠（Na₂SO₄）作为填料，经过特殊加工处理，在塑料薄膜中保持优异的透明度。与碳酸钙导致不透明不同，该母粒在显著降低成本的同时，保持最终产品的透明度和外观。非常适合对透明度要求高的应用场景。",
      applications: ["透明包装薄膜", "购物袋", "农用薄膜", "复合薄膜"],
      features: [
        "高硫酸钠填充量（高达80%）",
        "保持薄膜透明度和清晰度",
        "相比纯树脂显著降低成本",
